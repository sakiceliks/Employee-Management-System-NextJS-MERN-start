...
import CalisanlarTable from '../components/calisanlarTable'
...
export default function Calisanlar() {
  ...
  return (
    <div className={styles.container}>
      ...
      <h1 className='text-xl text-gray-200 md:text-4xl text-center font-bold py-10'>Çalışan Listesi </h1>
...
<CalisanlarTable></CalisanlarTable>
</div>
      </main>
